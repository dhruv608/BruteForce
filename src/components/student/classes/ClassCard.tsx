...
export const ClassCard: React.FC<ClassCardProps> = ({
  ...
  return (
    <Link
      ...
      className=" backdrop-blur-2xl flex border border-border/60 hover:border-logo/40 rounded-2xl overflow-hidden transition-all duration-300 hover:-translate-y-[2px] hover:shadow-lg hover:shadow-primary/5"
    >
        ...
        <div className="flex items-center justify-between gap-4">
          ...
          {pdfUrl ? (
            <button
              ...
              className="flex items-center gap-1.5 px-2.5 py-1 text-xs rounded-2xl text-black bg-primary dark:text-primary dark:bg-primary/10 border border-primary/20 hover:bg-logo/20 transition-all font-medium"
            >
