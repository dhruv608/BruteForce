...
import { TopicCardProps } from "@/types/admin/topic.types";
...
export default function   TopicCard({
  ...
  return (
    <div
      ...
      className=" glass backdrop-blur-2xl hover-glow rounded-2xl overflow-hidden cursor-pointer transition-all duration-300 group"
    >
